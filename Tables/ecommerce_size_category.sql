...
CREATE TABLE `size_category` (
  `size_cat_id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(50) NOT NULL,
  PRIMARY KEY (`size_cat_id`)
...
INSERT INTO `size_category` VALUES (1,'Clothing Sizes'),(2,'Shoe Sizes'),(3,'Clothing Sizes'),(4,'Shoe Sizes');
